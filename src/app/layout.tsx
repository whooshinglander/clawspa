...
import { DM_Sans, Playfair_Display, Roboto_Slab, Great_Vibes } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${dmSans.variable} ${playfair.variable} ${robotoSlab.variable} ${greatVibes.variable} font-sans min-h-screen antialiased`}>
        <Script
