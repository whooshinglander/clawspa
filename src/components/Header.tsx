    ...
    <header className="sticky top-0 z-50 bg-bg/80 backdrop-blur-xl">
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <Link href="/" className="focus-ring flex items-center gap-2 text-xl font-display font-semibold rounded-lg tracking-wide">
          ...
          <span>
            <span className="text-text-primary font-bold" style={{ fontFamily: "var(--font-slab)", fontSize: "1.5rem" }}>Claw</span><span className="text-accent font-normal" style={{ fontFamily: "var(--font-script)", fontSize: "1.6rem" }}>Spa</span>
          </span>
        </Link>
